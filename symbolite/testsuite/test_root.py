...
from symbolite.abstract.symbol import Symbol
from symbolite.operands import Function
from symbolite.translators import find_libs_in_stack
...
def test_find_libs_in_stack():
    ...
    from symbolite.impl.symbol import default as libsymbol  # noqa: F401
